...
## Corpus Check
- 69 files · ~13,644 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 432 nodes · 890 edges · 38 communities (36 shown, 2 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `026015e6`
...
- `SessionAuthService` --uses--> `NoActiveTeamSelectedError`  [INFERRED]
  backend/app/services/auth.py → backend/app/error.py
...
Cohesion: 0.08
Nodes (44): delete_task(), get_task(), get_tasks(), patch_task(), post_task(), CurrentSessionDep, DbSessionDep, # TODO: Task doesn't have to have assignee, it can be picked up by anyone if nob (+36 more)
...
Cohesion: 0.14
Nodes (33): bootstrap_setup(), Response, ApiConflictError, ApiInternalServerError, AppAlreadyBootstrappedError, AppError, InvalidBootstrapSecretError, InvalidTaskError (+25 more)

### Community 4 - "Community 4"
Cohesion: 0.14
Nodes (21): auth_user(), login(), logout(), CurrentSessionDep, DbSessionDep, Response, SessionTokenDep, ChangePasswordResult (+13 more)

### Community 5 - "Community 5"
Cohesion: 0.18
Nodes (17): get_current_session(), DbSessionDep, SessionTokenDep, get_db(), Session, AuthenticationFailedError, InvalidSessionError, UserSession (+9 more)
...
Cohesion: 0.06
Nodes (32): 1st Version of MVP, 2nd Version of MVP, Account Settings, Adding a Task, Analytics, Blocker Handshake, Combined Filters, Debrief System (+24 more)
...
## Knowledge Gaps
- **114 isolated node(s):** `$schema`, `eslint`, `typescript`, `unicorn`, `oxc` (+109 more)
...
- **What connects `# TODO: Task doesn't have to have assignee, it can be picked up by anyone if nob`, `# TODO: Should I prevent duplicate titles of tasks?`, `# TODO: Store in database` to the rest of the system?**
